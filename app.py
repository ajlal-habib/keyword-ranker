...
def main():
    ...
    with st.sidebar:
        ...
        target_domain = st.text_input("Target Domain", placeholder="folio3.com")
        serpapi_key = st.text_input("SerpApi Key", type="password")
        
        st.divider()
        
        st.markdown("### 📝 Instructions")
        # Fixed the multi-line string here
        st.markdown("""
        1. **Domain**: Enter your root domain.
        2. **API Key**: Get your key from SerpApi.com.
    ...
    if uploaded_file is not None:
        try:
            ...
            if kw_col:
                ...
                st.error("❌ Could not find a 'Keyword' column.")
        except Exception as e:
        ...
        if not target_domain:
            ...
            with st.spinner("Analyzing Google Search Results..."):
                ...
                for i, keyword in enumerate(keywords):
                    ...
                    results_data.append({"Keyword": keyword, "Current Rank": rank, "URL": url})
            ...
            with metrics_container:
                ...
                m1.metric("Total Keywords", len(results_df))
            ...
            st.download_button("📥 Download Results as CSV", data=csv_data, file_name="rank_report.csv", mime="text/csv")
